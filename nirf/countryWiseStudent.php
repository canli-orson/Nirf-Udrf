...
if (isset($_POST['submit'])) {
	...
	if ($result) {
		...
		if ($row) {
			$p_code = $row['PROGRAM_CODE']; // Use the fetched PROGRAM_CODE

			// Your other variables...
			$countryCode = $_POST['countryCode'];
			$Country_wise_student = trim(strip_tags(filter_input(INPUT_POST, 'Country_wise_student', FILTER_SANITIZE_NUMBER_INT)));
...
?>
<!-- Your HTML form and table code here -->
		...
		<div class="mb-3">
			...
			<select name="countryCode" class="form-control" id="">
				...
				<optgroup label="Other countries">
					...
					<option data-countryCode="MP" value="670">Northern Marianas (+670)</option>
					...
					<option data-countryCode="LC" value="1758">St. Lucia (+1758)</option>
	...
	<div class="col ">
		<div class="overflow-auto">
			<table class="table bg-white rounded shadow-sm  table-hover ">
				...
				<tbody>
					<?php
					$Record = mysqli_query($conn, "SELECT * FROM country_wise_student WHERE DEPT_ID = '$dept' AND A_YEAR = '$A_YEAR'");
